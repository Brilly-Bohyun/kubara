...
type Cluster struct {
	...
	// Deprecated: use Networking.IngressClassName. Retained for older catalogs.
	IngressClassName string             `json:"ingressClassName,omitempty" yaml:"ingressClassName,omitempty" jsonschema:"minLength=1,description=Deprecated. Use networking.ingressClassName."`
...
type ClusterNetworking struct {
	IngressClassName string                    `json:"ingressClassName,omitempty" yaml:"ingressClassName,omitempty" jsonschema:"minLength=1,description=Ingress class. Defaults to traefik when no Gateway is configured."`
